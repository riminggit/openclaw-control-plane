...
const GatewaySettingsPage = lazy(() => import('./pages/GatewaySettingsPage').then(m => ({ default: m.GatewaySettingsPage })))
...
const AgentLifecyclePage = lazy(() => import('./pages/AgentLifecyclePage').then(m => ({ default: m.AgentLifecyclePage })))
